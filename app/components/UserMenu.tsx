...
export default function UserMenu() {
  ...
  // Get user's initials or email first letter
  const getInitials = () => {
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        >
          <div className="h-9 w-9 rounded-full bg-[#3F51B5] text-white flex items-center justify-center text-sm font-medium hover:bg-[#283593] transition-colors">
            {getInitials()}
          </div>
        </button>

        {isOpen && (
          <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-[#E7E5E4] py-2 z-50">
